...
public class EliminarCliente extends javax.swing.JInternalFrame {
    ...
    private void eliminarCliente() {
        try {
            ...
            LCliente logicaCliente = new LCliente();
            int resultado = logicaCliente.Eliminar(idCliente);
            if (resultado > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Ingrese un ID válido para el cliente.");
        }
    }
